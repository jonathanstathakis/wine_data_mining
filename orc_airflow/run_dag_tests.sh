...
airflow dags test wine_list_etl_extract &&
  ...
  airflow dags test wine_list_etl_tform_section_path &&
  airflow dags test wine_list_etl_tform_col_decomp &&
  airflow dags test wine_list_etl_load &&
  open '/Users/jonathan/jonathan/projects/wine_wiki/wine_data_mining/orc_airflow/orc_airflow/airflow/include/test.csv'
